...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center space-x-3 shrink-0">
          ...
          <div className="relative inline-flex items-center">
            ...
            <select
              defaultValue="30d"
              className="pl-9 pr-8 py-2 rounded-xl bg-surface-2 border border-borderSubtle text-xs font-semibold text-textPrimary hover:bg-surface-3 transition-colors cursor-pointer appearance-none shadow-sm"
            >
            ...
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-textTertiary pointer-events-none text-xs">▾</span>
          </div>
          <Link
            href="/feedback"
            className="inline-flex items-center justify-center px-4 py-2 bg-accent-500 hover:bg-accent-400 text-white text-xs font-semibold rounded-xl transition-all duration-200 shadow-md shadow-accent-500/20 hover:shadow-accent-500/35"
          >
      ...
      {/* Grid Row 1: Feedback Volume & Sentiment Breakdown */}
